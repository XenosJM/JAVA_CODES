...
//	  = this.setBounds(100, 100, 450, 300);
		...
		JComboBox comboBoxMemberTime = new JComboBox();
		comboBoxMemberTime.setBounds(211, 280, 187, 44);
		comboBoxMemberTime.addItem("시간 선택");
		comboBoxMemberTime.addItem("1시간 추가");
		comboBoxMemberTime.addItem("3시간 추가");
		comboBoxMemberTime.addItem("5시간 추가");
		comboBoxMemberTime.addItem("10시간 추가");		
		comboBoxMemberTime.setVisible(false);
